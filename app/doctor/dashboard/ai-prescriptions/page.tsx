...
export default function AIPrescriptionsPage() {
  ...
  const [currentPrescription, setCurrentPrescription] = useState<Medication[]>([])
  ...
  const handleAddMedication = () => {
    if (medicationName && dosage && frequency && duration) {
      ...
      setMedicationName("")
      setDosage("")
      // setFrequency("") // Keep frequency for next med?
      setDuration("")
    }
  }
        ...
        <Card className="shadow-md">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              />
              {/* Medication suggestions could be implemented here */}
            </div>
